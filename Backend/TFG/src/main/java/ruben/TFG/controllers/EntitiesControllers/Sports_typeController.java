...
import ruben.TFG.model.DTO.Sports_typeDTO;
...
public class Sports_typeController {
    ...
    public Sports_typeController(Sports_typeService sportsTypeService) {
        ...
        @PostMapping("/")
        public ResponseEntity<Sports_typeDTO> createUser(@RequestBody Sports_type sport_type) {
        ...
        @PutMapping("/{id}")
        public ResponseEntity<Sports_typeDTO> updateUser(@PathVariable Long id,  @RequestBody Sports_type sport_type) {
